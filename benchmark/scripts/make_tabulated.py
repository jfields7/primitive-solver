...
conv_temp = 11604447517.053463
conv_dens = 1674928099929566.0 # DD2
#conv_dens = 1674928212403005.8 # LS220
...
success = np.reshape(success, newshape=(nT, nn))
...
#plt.savefig('dd2_iter.pdf')
plt.savefig('ls220_iter.png')
plt.savefig('ls220_iter.pdf')
...
#plt.savefig('dd2_err.pdf')
plt.savefig('ls220_err.png')
plt.savefig('ls220_err.pdf')
